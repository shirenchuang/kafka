...
class BrokerListSortedTest extends ZooKeeperTestHarness {
  val brokerId1 = 0
  val brokerId2 = 1
  val brokerId3 = 2
  val brokerId4 = 3
  ...
  override def setUp(): Unit = {
    ...
    val configs = Seq(
      ...
      TestUtils.createBrokerConfig(brokerId4, zkConnect),
    TestUtils.createBrokerConfig(brokerId3, zkConnect),
  ...
  @Test
  def testGetAllBrokerAndEpochsInClusterSorted(): Unit = {

    val brokerAndEpochs = zkClient.getAllBrokerAndEpochsInCluster

    println(brokerAndEpochs)
